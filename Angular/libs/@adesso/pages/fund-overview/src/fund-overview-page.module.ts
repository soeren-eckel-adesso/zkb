...
import { FundOverviewPageComponent } from "./components/fund-overview-page.component";
...
@NgModule({
  declarations: [FundOverviewPageComponent],
  imports: [
    CommonModule,
...
export class FundOverviewPageModule {
