...
import { DerivativeDetailPageComponent } from "./components/derivative-detail-page.component";
...
const routes: Routes = [
  {
    path: "",
    component: DerivativeDetailPageComponent,
  },
];

@NgModule({
  declarations: [DerivativeDetailPageComponent],
  imports: [
    CommonModule,
...
export class DerivativeDetailPageModule {
