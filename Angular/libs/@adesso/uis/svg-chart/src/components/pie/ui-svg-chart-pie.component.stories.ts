...
import { SvgChartUiModule, UiSvgChartPieComponent } from "@adesso/ui-svg-chart";
import { StorybookTranslateModule } from "../../../../../../../.storybook/StorybookTranslateModule";

storiesOf("@Adesso / UI / Charts / SvgChart / Pie", module)
  .addDecorator(moduleMetadata({ imports: [SvgChartUiModule, StorybookTranslateModule] }))
  .add("Filled", () => ({
    component: UiSvgChartPieComponent,
    props: {
      items: [
